...
public class ElevatorSubsystem extends SubsystemBase {
  ...
  private final SmartMotorControllerConfig motorConfig =
      new SmartMotorControllerConfig(this)
          ...
          .withClosedLoopController(
              4, 0, 0, MetersPerSecond.of(0.5), MetersPerSecondPerSecond.of(0.5))
  ...
  private final SmartMotorController motor =
      new SparkWrapper(elevatorMotor, DCMotor.getNEO(1), motorConfig);
  ...
  public Command joystickCmd(DoubleSupplier dutycyleSupplier) {
    return elevator.set(dutycyleSupplier);
  }
