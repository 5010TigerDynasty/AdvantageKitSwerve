...
public class SmartMotorFactory {
  ...
  public static final Map<String, MotorControllerConstructor> availableControllers =
      new HashMap<>();

  static {
    register("com.ctre.phoenix6.hardware.TalonFX", "yams.motorcontrollers.remote.TalonFXWrapper");
    register("com.ctre.phoenix6.hardware.TalonFXS", "yams.motorcontrollers.remote.TalonFXSWrapper");
    register("com.revrobotics.spark.SparkBase", "yams.motorcontrollers.local.SparkWrapper");
    register("com.thethriftybot.ThriftyNova", "yams.motorcontrollers.local.NovaWrapper");
  }
  ...
  private static void register(String motorControllerClassName, String wrapperClassName) {
    try {
      ...
      MotorControllerConstructor constructor =
          (params) -> {
            try {
  ...
  public static Optional<SmartMotorController> create(
      Object controllerInstance, Object... extraParams) {
    ...
    while (clazz != null) {
      ...
      if (constructor != null) {
        return Optional.of(
            instantiateMotorController(constructor, controllerInstance, extraParams));
      }
  ...
  private static SmartMotorController instantiateMotorController(
      MotorControllerConstructor constructor, Object controllerInstance, Object[] extraParams) {
