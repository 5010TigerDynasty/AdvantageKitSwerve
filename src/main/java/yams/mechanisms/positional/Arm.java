    ...
    if (RobotBase.isSimulation()) {
      ...
      mechanismRoot =
          mechanismWindow.getRoot(
              ...
              config
                  .getMechanismPositionConfig()
                  .getMechanismX(config.getLength().get())
                  .in(Meters),
              config
                  .getMechanismPositionConfig()
                  .getMechanismY(config.getLength().get())
                  .in(Meters));
      mechanismLigament =
      ...
      if (motor.getConfig().getMechanismLowerLimit().isPresent()
        ...
        mechanismRoot.append(
            new MechanismLigament2d(
                "MaxSoft",
                Inch.of(3).in(Meters),
                motor.getConfig().getMechanismUpperLimit().get().in(Degrees),
                4,
        ...
        mechanismRoot.append(
            new MechanismLigament2d(
                "MinSoft",
                Inch.of(3).in(Meters),
                motor.getConfig().getMechanismLowerLimit().get().in(Degrees),
                4,
