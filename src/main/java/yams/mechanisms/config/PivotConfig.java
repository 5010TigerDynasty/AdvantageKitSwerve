...
public class PivotConfig {
  ...
  @Deprecated protected Optional<String> networkRoot = Optional.empty();
  /** Telemetry name. */
  ...
  /**
   * Lower Hard Limit for the {@link yams.mechanisms.positional.Pivot} to be representing in
   * simulation.
   */
  ...
  /**
   * {@link yams.mechanisms.positional.Pivot} MOI from CAD software. If not given estimated with
   * length and weight.
   */
   ...
   * yams.mechanisms.positional.Pivot} for simulation.
   *
   ...
   */
  @Deprecated
  public PivotConfig withTelemetry(
  ...
  /**
   * Wrap the pivot around these angles. When the pivot exceeds the maximum angle it will read as if
